...
/*
** As the server never initialize an action all
**function here are called events
*/
...
**/
int server_event_team_created( // - used
...
**/
int server_event_channel_created( // used
    char const *team_uuid,
...
**/
int server_event_thread_created( // - done
    char const *channel_uuid,
...
** /create "reply_body"
**/
int server_event_reply_created( // - done
    char const *thread_uuid,
    char const *user_uuid,
...
**/
int server_event_user_unsubscribed(char const *team_uuid, char const
*user_uuid);
// - done
/**
...
** /login
**/
int server_event_user_logged_in(char const *user_uuid); // -used
