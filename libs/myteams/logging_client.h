...
/*
** To get team information or team modifications (list threads,
**create reply...)
** you MUST be subscribed to the team.
*/

/**
** @brief Must be called when a user successfully login
**to the server (/login).
** When you log in (/login) you should also receive from
**the server this event.
